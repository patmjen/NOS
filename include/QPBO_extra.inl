...
template <typename REAL>
	inline void QPBO<REAL>::ComputeRandomPermutation(int N, int* permutation)
{
	int i, j, k;
	for (i=0; i<N; i++)
	{
...
template <typename REAL>
	inline void QPBO<REAL>::MergeMappings(int nodeNum0, int* mapping0, int* mapping1)
{
	int i;
...
template <typename REAL>
	inline int QPBO<REAL>::MergeParallelEdges(Arc* a1, Arc* a2)
{
...
template <typename REAL>
	inline void QPBO<REAL>::AllocateNewEnergy(int* mapping)
{
	int i_index, j_index;
...
template <typename REAL>
	inline void QPBO<REAL>::SetMaxEdgeNum(int num)
{
	if (num > GetMaxEdgeNum()) reallocate_arcs(2*num);
}

template <typename REAL>
	inline bool QPBO<REAL>::Probe(int* mapping)
{
...
template <typename REAL>
	inline void QPBO<REAL>::Probe(int* mapping, ProbeOptions& options)
{
...
template <typename REAL>
	inline bool QPBO<REAL>::Improve(int N, int* order_array, int* fixed_nodes)
{
	int p, i_index;
	Node* i;
	Node* _i[2];
