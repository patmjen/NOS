...
template <typename REAL>
	inline void QPBO<REAL>::maxflow_init()
{
	Node *i;
...
template <typename REAL>
	inline void QPBO<REAL>::maxflow_reuse_trees_init()
{
	Node* i;
	Node* j;
...
template <typename REAL>
	inline void QPBO<REAL>::augment(Arc *middle_arc)
{
	Node *i;
	Arc *a;
	REAL bottleneck;
...
template <typename REAL>
	inline void QPBO<REAL>::process_source_orphan(Node *i)
{
	Node *j;
...
template <typename REAL>
	inline void QPBO<REAL>::process_sink_orphan(Node *i)
{
	Node *j;
	Arc *a0, *a0_min = NULL, *a;
	int d, d_min = INFINITE_D;
...
template <typename REAL>
	inline void QPBO<REAL>::maxflow(bool reuse_trees, bool _keep_changed_list)
{
...
template <typename REAL>
	inline void QPBO<REAL>::test_consistency(Node* current_node)
{
	Node *i;
	Arc *a;
	int r;
