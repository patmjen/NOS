...
template <typename REAL>
	inline void QPBO<REAL>::InitFreeList()
{
	Arc* a;
	Arc* a_last_free;
...
template <typename REAL>
	inline void QPBO<REAL>::reallocate_nodes(int node_num_max_new)
{
...
template <typename REAL>
	inline void QPBO<REAL>::reallocate_arcs(int arc_num_max_new)
{
...
template <typename REAL>
	inline bool QPBO<REAL>::Save(char* filename)
{
	int e;
	int edge_num = 0;
...
template <typename REAL>
	inline bool QPBO<REAL>::Load(char* filename)
{
	Reset();
...
template <typename REAL>
	inline typename QPBO<REAL>::EdgeId QPBO<REAL>::AddPairwiseTerm(NodeId _i, NodeId _j, REAL E00, REAL E01, REAL E10, REAL E11)
{
...
template <typename REAL>
	inline void QPBO<REAL>::AddPairwiseTerm(EdgeId e, NodeId _i, NodeId _j, REAL E00, REAL E01, REAL E10, REAL E11)
{
...
template <typename REAL>
	inline void QPBO<REAL>::TransformToSecondStage(bool copy_trees)
{
...
template <typename REAL>
	inline void QPBO<REAL>::MergeParallelEdges()
{
...
template <typename REAL>
	inline REAL QPBO<REAL>::ComputeTwiceEnergy(int option)
{
...
template <typename REAL>
	inline REAL QPBO<REAL>::ComputeTwiceEnergy(int* solution)
{
	REAL E = 2*zero_energy, E1[2], E2[2][2];
	int i, j, e;
...
template <typename REAL>
	inline REAL QPBO<REAL>::ComputeTwiceLowerBound()
{
...
template <typename REAL>
	inline void QPBO<REAL>::TestRelaxedSymmetry()
{
	Node* i;
	Arc* a;
	REAL c1, c2;
